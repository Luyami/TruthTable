...
/**
 * Representa a interface gráfica da tabela verdade
 */
public class ResultadoExpressao extends javax.swing.JFrame {
    ...
    //Se uma tabela verdade já estiver aberta para uma determinada fórmula, não devemos abrir outra
    ...
    //Atribui, para cada proposição, todos os valores que ela pode assumir em uma determinada tabela verdade
    ...
    //Calcula todos os valores possíveis para uma fórmula e atualiza a tabela verdade
    ...
    /**
     * Cria uma tabela verdade gráfica a partir da fórmula passada no construtor
     */
